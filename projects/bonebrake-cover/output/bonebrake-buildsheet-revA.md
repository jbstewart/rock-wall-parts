# Bonebrake Cover — Build Sheet  (Rev A, 9.00 x 41.25)

Generated by bonebrake_assembly.py at Rev A — regenerate, don't hand-edit.
Companion docs: bonebrake-drillmap-revA.pdf (hole letters referenced below), bonebrake-bom-revA.md.
...
- Clamp face on middle, art side up, edges flush. Drill pilot pairs TOGETHER:
  4x A (9/32"), 10x B (13/64"). Deburr.
- CAM: full Fusion op settings (small-hole pilot recipe + profile ops) are in
  bonebrake-camsheet-revA.md — set up from that sheet, not from memory.
